...
const miniaturaUrl = "https://img.youtube.com/vi/ov7vA5HFe6w/maxresdefault.jpg";

return (
    <div 
        className="w-full aspect-video rounded-lg boxShadow shadow-indigo-600 border-2 overflow-hidden  
